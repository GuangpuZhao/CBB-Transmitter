...
extern float SymbDuration;  //SymbDuration = 12.8e-6;
extern float CpDuration;  //CpDuration = 3.2e-6 CP³¤¶È°´3.2usÀ´µÄ
...
extern complex32 *X_VHTLTF[N_TX];
...
//interleaver table
extern int16 *streamweave_table[N_STS]; /**< å«å¯¼é¢‘çš„åˆ†æµäº¤ç»‡è¡¨ */
